...
<div class="w-11/12 h-[85vh] mx-auto mt-10 px-[41px] py-2.5 bg-white rounded-lg flex-col justify-start items-start ">
    ...
    <div class=" flex flex-col gap-2 w-full ">
        <div class="w-full p-2.5 bg-zinc-100 border  border-white border-b-gray-500 justify-start items-start gap-2.5 inline-flex">
        ...
        <div class="flex flex-col gap-2 overflow-scroll h-[65vh] scrollbar-hide">
