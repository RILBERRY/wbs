...
<div class="w-11/12 mx-auto mt-10 rounded-lg flex-col justify-start items-start space-y-5 ">
    <div class="w-full px-[41px] py-2.5 bg-white rounded-lg flex-col justify-start items-start gap-2.5 inline-flex">
        <div class="self-stretch  p-2.5 justify-between items-center gap-2.5 flex flex-col lg:flex-row">
            <div class="text-black text-[24px] font-bold text-left w-full lg:w-fit">Setting</div>
            <div class=" justify-end items-center gap-2.5 flex">
                <div class="w-fit lg:w-32 px-2.5 py-[9px] {{$setting=='users'?'bg-fuchsia-900':'bg-zinc-500'}}  rounded-lg hover:bg-fuchsia-900 cursor-pointer justify-start items-center gap-2 flex"
                    onclick="navTo('/setting/users')">
                    <div class="w-5 h-5 relative hidden lg:inline">
                ...
                <div class="w-fit lg:w-32 px-2.5 py-[9px] {{$setting=='permissions'?'bg-fuchsia-900':'bg-zinc-500'}} rounded-lg hover:bg-fuchsia-900 cursor-pointer justify-start items-center gap-2 flex"
                    onclick="navTo('/setting/permissions')">
                    <div class="w-5 h-5 relative hidden lg:inline">
                ...
                <div class="w-fit lg:w-32 px-2.5 py-[9px] {{$setting=='address'?'bg-fuchsia-900':'bg-zinc-500'}} rounded-lg hover:bg-fuchsia-900 cursor-pointer justify-start items-center gap-2 flex"
                ...
                <div class="w-fit lg:w-32 px-2.5 py-[9px] {{$setting=='price-plans'?'bg-fuchsia-900':'bg-zinc-500'}} rounded-lg hover:bg-fuchsia-900 cursor-pointer justify-start items-center gap-2 flex"
                    onclick="navTo('/setting/price-plans')">
                    <div class="w-5 h-5 relative hidden lg:inline">
                        <svg width="100%" height="100%" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Frame 52">
                ...
                <div class="w-20 lg:w-32 px-2.5 py-[9px] {{$setting=='funds'?'bg-fuchsia-900':'bg-zinc-500'}} rounded-lg hover:bg-fuchsia-900 cursor-pointer justify-start items-center gap-2 flex"
    ...
    @component('app.setting.'.$setting.'-table')@endcomponent
